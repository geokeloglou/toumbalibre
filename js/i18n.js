(function () {
  const translations = {
    el: {
      ...
      modal_yes: "Ναι",
      modal_no: "Όχι",
      consent_note: "* Με τη συναίνεση ηλικίας χρησιμοποιούνται cookies για στατιστικά επισκεψιμότητας.",
      nav_product: "Προϊόν",
    ...
    en: {
      ...
      modal_yes: "Yes",
      modal_no: "No",
      consent_note: "* By confirming your age, cookies are used for traffic analytics.",
      nav_product: "Product",
      nav_order: "Order",
      nav_social: "Social",
      hero_kicker: "COCKTAIL MIX",
